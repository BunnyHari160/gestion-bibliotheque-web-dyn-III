...
public class EmpruntService {
    ...
    public String emprunterLivreAvecDate(int idAdherent, int idExemplaire, LocalDate dateEmprunt, LocalDate dateRetourPrevue) {
        ...
        empruntRepository.enregistrerEmprunt(idAdherent, idExemplaire, dateEmprunt, dateRetourPrevue);
